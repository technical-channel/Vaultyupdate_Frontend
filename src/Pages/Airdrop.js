  ...
  return (
    <div>
      ...
      >
        ...
        <>
        <div className="airdrophrader" style={{marginTop:'-70px'}}>
          ...
          <div
            className="main-header-content-container-airdrop mt-5 mb-5"
            style={{ justifyContent: "center" }}
          >
            <div
              className="main-header-content-principal-airdrop"
              style={{ flexDirection: "column", width: "10%" }}
            >
              <a
...
"
            ...
            <div
              className="main-header-content-principal-airdrop hover:translate-y-6"
              style={{ flexDirection: "column", width: "10%" }}
            >
              <a
