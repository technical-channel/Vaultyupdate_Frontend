        ...
        <header className="main-header" style={{ marginTop: "25px" }}>
          <div className="header-container">
            <nav className="main-header-navbar">
              <div className="flex max-auto gap-2">
                <img
                  src={logo}
                  alt="KeeSwap logo"
                ...
                <a href="/" style={{ textDecoration: "none" }}>
                  <h4 className="text-3xl mt-[2.5rem] text-[#fff] ">VAULTY</h4>
                </a>
              </div>
            ...
            >
              <div className="main-header-content-principal">
                ...
                <p className="main-header-content-principal__description typewriter">
                  Buying cryptos doesn’t have to be hurtful. With Vaulty, you
            ...
            <div className="why-us-section" id="buy">
              <div className="why-us-section__content">
                ...
                <p className="why-us-section__content__description">
                  ...
                  (All-In-One Wallet System). Vaulty was founded with a vision
                  to uplift trust and security throughout the digital spectrum
                  and with that, a group of technical and marketing teams has
                  been established in Dubai, Estonia & Ukraine.
                </p>
            ...
            <div className="cryptocurrencies-info-cards">
              <div className="info-card">
                ...
                <p className="info-card__description">
                  The platform will enable cryptocurrency traders to buy and
            ...
            <article className="invest-smart-article">
              ...
              >
                ...
                <p className="invest-smart-article__content__description">
                  ...
                  Fiat ($VLT) transactions done instantaneously and with ease.
